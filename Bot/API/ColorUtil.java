...
public class ColorUtil {
     ...
     * @param radius radius to search for from the first Color.
     ...
     * @param c2        second color
     * @param radius    radius to search for from the first Color.
     * @param tolerance integer that represents color tolerance, for instance 5 = new color(5,5,5)
     * @return the Point of the first found location of the specified second color
     */
     ...
     * @param c2        second color
     * @param radius    radius to search for from the first Color.
     * @param tolerance color object that represents tolerance
     * @return the Point of the first found location of the specified second color
     */
     ...
     * @param tolerance - the rgb values which can vary. If c = new Color(200,200,200)
    ...
    /**
     * @param c the desired color.
     * @param t - the rgb values which can vary. If c = new Color(200,200,200)
    ...
    /**
     * @param c the desired color.
     * @param b the buffered imagine in which you would like to search for the
     *          color specified.
     * @return Point location
     */
     ...
     *                  Such as tolerance = new Color(11,3,4) it could return anywhere
     *                  from (189,197,196) - (211,203,204)
     * @param b         - the buffered image in which you would like to search for the
    ...
    /**
     * @param c the desired color.
     * @param r the rectangle area on the screen in which you would like to
     ...
     *                  Such as tolerance = new Color(11,3,4) it could return anywhere
     *                  from (189,197,196) - (211,203,204)
     * @param r         - the rectangle on the screen in which you would like to
    ...
    /**
     * @param c - desired Color
     * @param b - the buffered image in which to search for the desired color
     * @return - Array of point locations for colors = c
     */
    ...
    /**
     * @param c         desired Color
     * @param b         the buffered image in which you would like to search
     * @param tolerance - the rgb values which can vary. If c = new Color(200,200,200)
     *                  Such as tolerance = new Color(11,3,4) it could return anywhere
     *                  from (189,197,196) - (211,203,204)
    ...
    /**
     * @param c - desired Color
     * @param r - the rectangle in which to search for the desired color
     * @return - Array of point locations for colors = c
     */
    ...
    /**
     * @param c         desired Color
     * @param r         the rectangle in which you would like to search for the
     ...
     * range.
     *
     * @param val   - the first integer you would like to compare
     * @param des   - the second integer you would like to compare
     ...
     *
     * @param p - The point at which you wish desire a color.
     ...
     *
     * @param x The x coordinate of the point at which you desire a color.
     * @param y The y coordinate of the point at which you desire a color.
    ...
    /**
     * @param c     the given color to search for.
    ...
    /**
     * @param area the area's rectangle.
    ...
    /**
     * @param b the BufferedImage to search it.
     ...
     * @param color2 the second color param t - the rgb values which can vary. If c
    ...
    /**
     * @param color1 the first color
     * @param color2 the second color param tolerance - the rgb values which can
