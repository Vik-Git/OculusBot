...
public class Screen{
    ...
    private static MediaTracker tracker = new MediaTracker(RSPSAppletStub.RSApplet);
    private static BufferedImage img = new BufferedImage(RSPSAppletStub.RSApplet.getWidth(),RSPSAppletStub.RSApplet.getHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    public synchronized static BufferedImage getTabScreen(){
    ...
    public static BufferedImage getGameScreen() throws InterruptedException {
        Graphics g = img.getGraphics();
